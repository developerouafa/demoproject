                    ...
                    <div class="card mg-b-20">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">Add Tags</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                            <tr>
                                                ...
                                                <td>{{$post->title}}</td>
                                                    ...
                                                    <td><form action="{{route('post_tags.delete', $x->id)}}" method="post">
                                                        @method('DELETE')
                                                        @csrf
                                                        {{$x->tag->title}}
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content modal-content-demo">
                        <div class="modal-header">
                            <h6 class="modal-title">Add Tags</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                        </div>
