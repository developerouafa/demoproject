                                ...
                                <form action="{{route('product_color.create')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <input placeholder="{{__('messagevalidation.users.color')}}" type="color" name="color" value="{{$x->color}}" class="form-control @error('color') is-invalid @enderror" id="color">
                                            {{-- <select name="color" value="{{old('color')}}" class="form-control SlectBox" class="@error('color') is-invalid @enderror">
                                                <option value="" selected disabled>{{__('messagevalidation.users.color')}}</option>
                                                    @forelse ($colors as $color)
                                                        <option value="{{ $color->id }}"> {{ $color->title }} </option>
                                                        @empty
                                                        <tr>
                                                            <td colspan="5" class="text-center">{{__('message.nocoloryet')}}</td>
                                                        </tr>
                                                    @endforelse
                                            </select> --}}
                                        </div>
