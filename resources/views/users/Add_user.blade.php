                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label>{{__('message.firstlastenglish')}} <span class="tx-danger">*</span></label>
                    ...
                    {{-- <div class="row row-sm mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <select name="Status_spaties" id="select-beast" class="form-control  nice-select  custom-select">
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                <label class="form-label"> {{__('message.uservalidity')}}</label>
                                {!! Form::select('roles_name[]', $roles,[], array('class' => 'form-control','multiple')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                        <button class="btn btn-main-primary pd-x-20" type="submit">{{__('message.uservalidity')}}</button>
                    </div>
                </form>
            </div>
        </div>
